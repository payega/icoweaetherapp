...
function renderHour(forecast, index) {
	...
	var s = 
		'<table id="hourCell_' + index + '" cellspacing="0px" width="28px" height="210px" style="border:1px solid transparent; margin:0 auto; background-color:' + color + '; color:white; user-select:none; -moz-user-select:-moz-none; cursor:pointer"'
