...
function renderHour(forecast, index) {
	...
	var s = 
		'<table id="hourCell_' + index + '" cellspacing="0px" width="28px" height="230px" style="border:1px solid transparent; margin:0 auto; background-color:' + color + '; color:white; user-select:none; -moz-user-select:-moz-none; cursor:pointer"'
	...
	+		'<tr>'
	+			'<td valign="top" align="center">'
	+				'<span style="font-size:9pt;">' + forecast.temp + '&#176;</span>'
	+			'</td>'
	+	 	'</tr>'
	+		'<tr>'
	+			'<td valign="top" align="center">'
	+				'<span style="font-size:9pt;">' + forecast.wspd + '</span>'
	+			'</td>'
	+	 	'</tr>'
	+		'<tr>'
	+			'<td valign="top" align="center">'
	...
	+	 	'</tr>'	
		+		'<tr>'
	+			'<td valign="top" align="left" height="30px" width="30px">'
	+ 				'<img vspace="3px" hspace="3px" width="22px" height="22px" src="' + getIconURL(forecast.wdir_cardinal) + '"/>'
	+			'</td>'
	+	 	'</tr>'
	+		'<tr>'
	+			'<td valign="top" align="center">'
	+				'<span style="font-size:6pt;">' + forecast.mslp + '</span>'
	+			'</td>'
	+	 	'</tr>'	
...
{
     document.getElementById("weather_display").style.background = "url('images/"+ code + ".jpg')";
}
